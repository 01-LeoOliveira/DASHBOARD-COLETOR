/*
  ...
  - You are about to alter the column `id` on the `historico` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `Int`.
